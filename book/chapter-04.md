...
![The shape of the BCM learning function. Note the similarity in qualitative shape to both the XCAL dWt function ([@fig:fig-xcal-dwt-fun]) and synaptic plasticity as function of $Ca^{++}$ ([@fig:fig-ltp_ltd_ca2+]).](../figures/fig_bcm_function.png){#fig:fig-bcm-function width=40% }
